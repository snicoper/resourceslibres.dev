...
NAME="resourceslibres.com" # Name of the application
DJANGODIR=/var/webapps/resourceslibres.com/src/ # Django project directory
...
cd $DJANGODIR
source /home/snicoper/.virtualenvs/resourceslibres.com/bin/activate
