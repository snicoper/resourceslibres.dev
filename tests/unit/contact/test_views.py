...
class ContactViewTest(BaseContactTest):
    ...
    def test_status_code_200(self):
        """Tanto un usuario logueado como anónimo obtiene
        el status_code 200.
        """
        # Usuario logueado.
...
class ContactMessageListViewTest(BaseContactTest):
    ...
    def test_templete_usado(self):
        ...
        self.assertTemplateUsed(self.response, 'contact/list.html')
...
class ContactMessageDetailViewTest(BaseContactTest):
    ...
    def test_templete_usado(self):
        """Prueba el template usado."""
        self.assertTemplateUsed(self.response, 'contact/details.html')
    ...
    def test_context_data(self):
        """El mensaje lo marca como leido."""
