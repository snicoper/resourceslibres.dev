...
# Producción
VIRTUAL_ENV_PROD="resourceslibres.com"

# Desarrollo
VIRTUAL_ENV_DEV="resourceslibres.dev"
...
BACKUPS_DIR="${HOME}/backups/resourceslibres.com"
...
DATABASE_NAME="resourceslibresdev"
...
PROD_DATABASE_NAME="resourceslibrescom"

# Usuario db
PROD_DATABASE_USER="resourceslibrescom"
